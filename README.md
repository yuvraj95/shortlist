...
**Type:** Personal Product | Job Discovery Tool | Vibe Coded  
...
As someone who has been on both sides of the hiring process, I wanted to experience what it feels like to build a product end to end — from PRD to shipped prototype — using AI-assisted vibe coding. Shortlist is that project.

It is also a genuine tool I use. Every feature in it was built to solve a real frustration I had with existing job boards.
...
- Universal Search — search the live job market by keyword and location without a resume
- Application drafts — draft answers per job with autosave
...
Personal prototype built by Yuvraj Gulati with Lovable. Not affiliated with LinkedIn, Indeed, or any job-board operator. Scraped data is used only for personal job search. Review each source's Terms of Service before deploying beyond personal use.
